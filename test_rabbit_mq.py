...
msgs = []
msgs.append({"content":"every things is fine"})
msgs.append({"content":"part of things is fine"})
msgs.append({"content":"nothing is fine"})

while(1):
   print(m_rabbitmq_client.write(exchange_name, exchangeType, [queue_name], msg=msgs[np.random.randint(3)]))
